...
class AliNewsZzController extends PayController
{
    ...
    public function Pay($array)
    {
        ...
        if($this->isMobile2()){
            $this->display("AliNewsZz/alipayMobile");
        }else{
            $this->display("AliNewsZz/alipayMobile");
        }
    }
    ...
    public function automaticAlipayQuery(){
        ...
        if ($order['pay_status'] == 0) {
            ...
            //$data['h5'] = "alipays://platformapi/startapp?appId=66666743&url=".urlencode($data['url']);
            $data['h5'] = "alipays://platformapi/startapp?appId=66666743&url=". $redirect_uri;
