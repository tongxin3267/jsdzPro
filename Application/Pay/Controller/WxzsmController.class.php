...
class WxzsmController extends PayController
{
    ...
    public function Pay($array)
    {
        ...
        $url = U('Wxzsm/skf',array('id'=>$return['orderid']),true,true);
        $payurl = U('Wxzsm/orderdetail',array('id'=>$return['orderid']),true,true);
...
//        }
        ...
        $this->assign("wxzsmImg",$return['wxzsmImg']);
        $this->assign('params',$return);
        $this->assign('orderid',$return['orderid']);
        $this->assign('money',sprintf('%.2f',$pay_amount));
        $this->display("WeiXin/wxzsm");
