...
<title>商户注册 - <?php echo ($sitename); ?> - 支付技术服务商，让支付简单、专业、快捷！</title>
...
<div class=" login2">
	<div class="login-wp">
		...
		<div class="login-bd">
			 <form action="<?php echo ($register_checkRegister); ?>" class="formLogin" method="post" id="defaultForm" >
			<ul>
				<li>
              ...
              <li>
					<input type="password" class="txt" name="password" id="confirmpassword" placeholder="请再次输入密码" aria-required="true" autocomplete="off"/>
				</li>
                 <li>
					<input type="text" class="txt" name="email" id="email" placeholder="请输入您的Email地址" aria-required="true" autocomplete="off"/>
				</li>
              
                <?php if($siteconfig['invitecode'] == 1): ?><li>
                             <input type="text" class="txt" id="invitecode" name="invitecode" placeholder="必须有邀请码才能注册" value="">
                     </li><?php endif; ?>
              
				<!--<li>
					<input type="text" class="txt-code" name="varification"  maxlength="5" id="secondCode" placeholder="图形验证码" />
			...
			<div class="login-ft">
				已有账号？点这里--><a href="<?php echo ($user_login); ?>">登录</a>
			</div>
		</div>
	</div>
</div>
...
<script>
    ...
    layui.use(['laydate', 'form', 'layer', 'table', 'element'], function() {
        ...
        $("#regBtn").click(function () {
            ...
            $.ajax({
                type:'post',
                url:'<?php echo ($register_checkRegister); ?>',
                            ...
                            layer.open({
                                ...
                                content: TipsContent,
                                    ...
                                    setTimeout(function () {
                                        ...
                                        setTimeout(function() {
                                            window.location.href = "<?php echo ($siteurl); ?>" + "Home_Index_userLogin.html";
                                        },3000 );
