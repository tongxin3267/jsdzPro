...
<title>商户登录 - <?php echo ($sitename); ?> - 支付技术服务商，让支付简单、专业、快捷！</title>
...
<div class=" login2">
	<div class="login-wp">
		...
		<div class="login-bd">
			 <form action="<?php echo ($user_checklogin); ?>" class="formLogin" method="post" id="defaultForm" >
			<ul>
				<li>
				...
				<li>
					<input type="text" class="txt txt-code" name="varification"  maxlength="5" id="secondCode" placeholder="图形验证码" style="width:98%;" />
