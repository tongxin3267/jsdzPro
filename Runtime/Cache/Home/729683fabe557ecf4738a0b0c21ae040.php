...
<title>开发者中心 - <?php echo ($sitename); ?> - 监控下载 - 支付技术服务商，让支付简单、专业、快捷！</title>
...
<div class="banner">
	<div class="wrapper">
		<h2 class="wow fadeInUp">SDK下载</h2>
		<p class="wow fadeInUp" data-wow-delay='.5s'>-SDK download -</p>
	</div>
</div>
<div class="sdk">
	<div class="wrapper">
		<ul class="clear">
			<li>
				...
				<div class="img">
					<img src="<?php echo ($style); ?>picture/img_29.png"/>
				</div>
				<div class="btn">
					<a href="/Uploads/demo.rar">下载</a>
				</div>
			</li>
			<li>
				<div class="txt">
				...
				<div class="img">
					<img src="<?php echo ($style); ?>picture/img_30.png"/>
				</div>
				<div class="btn">
					<a href="/Uploads/demo.rar">下载</a>
				</div>
			...
			<li>
				...
				<div class="img">
					<img src="<?php echo ($style); ?>picture/img_31.png"/>
				</div>
				<div class="btn">
					<a href="/Uploads/demo.rar">下载</a>
				</div>
			...
			<li>
				...
				<div class="img">
					<img src="<?php echo ($style); ?>picture/img_32.png"/>
				</div>
				<div class="btn">
					<a href="/Uploads/demo.rar">下载</a>
				</div>
			...
			<li>
				...
				<div class="img">
					<img src="<?php echo ($style); ?>picture/img_33.png"/>
				</div>
				<div class="btn">
					<a href="/Uploads/demo.rar">下载</a>
				</div>
