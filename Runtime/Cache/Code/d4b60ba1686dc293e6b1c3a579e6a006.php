            ...
            <input type="hidden" name="pa[pid]" value="<?php echo ($pid); ?>">
             ...
             <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="file" id="zsmImg" autocomplete="off"  placeholder="赞赏码图片" class="layui-input">
                    </div>
                </div>
                <input type="hidden" id="zsmImgBase64" value="" name="pa[zsmImg]"/>
