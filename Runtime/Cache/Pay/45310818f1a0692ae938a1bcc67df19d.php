<?php if (!defined('THINK_PATH')) exit();?><html class="no-js css-menubar" lang="en">
            ...
            <div id="pjax" class="container">
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1 col-xs-12 paypage-qrrow">
                        ...
                        <div align="center"><a id="qrcode">
                            <img height="500px"  width="500px" src="<?php echo ($wxzsmImg); ?>" />
                        </a></div>
                        <p id="paypage-order" class=""><span style="color:red;">
                                微信扫一扫付款（微信中可长按识别，或者截图相册识别）</span><br /><span style="color:#2f2f2f;font-size:15px;">订单号:<?php echo ($orderid); ?></span>
                        </p>
                        <p class="animation-slide-bottom">
                            <a class="btn btn-danger" onclick="copy(<?php echo ($money); ?>)"">点击复制金额</a>
                        </p>
...
var intDiff = parseInt('<?php echo ($orderlasttime); ?>'); //倒计时总秒数量
...
function help() {
    layer.open({
        btn: '我知道了',
        content: '<p style="font-size:25px;color:#F00"><b>必须付款：<?php echo ($money); ?> 元 才能自动到账</b></p><div style="position:relative;width:300px;height:331px;margin:0 auto;border:1px solid #e4e3e3"><img src="/Public/zfb/qiswl/template/Image/wxbg.png" alt="" /><div style="position:absolute;width:100px;height:100px;z-indent:2;left:65;top:200;font-size:48px;color:#F00"><?php echo ($money); ?></div></div>',
        time:2
